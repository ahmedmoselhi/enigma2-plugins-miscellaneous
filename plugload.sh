...
# Use curl and jq to fetch the list of files and filter for the PlugLoad archive
# The file list is a JSON array. We filter for name starting with "PlugLoad" and ending with ".tar.gz",
...
EXTRACTED_FOLDER="${DOWNLOAD_DIR}/${FILE_PREFIX}" # Still assume extracted folder is just 'PlugLoad'
